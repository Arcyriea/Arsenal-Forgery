{  
  ...
  {5, name="LMG Turret", features=PALETTE|TURRET|CANNON|AUTOFIRE, group=8, shape=RIGHT_TRI, barrelOffset={-4, 0},
  ...
  {7, name="Fragropper SS-100", features=PALETTE|LAUNCHER, group=2, shape=RECT_LAUNCHER1,
    ...
    {command={}, features=COMMAND|THRUSTER|GENERATOR|LAUNCHER|TORQUER|EXPLODE,
      ...
      {features=EXPLODE|COMMAND|CANNON|GENERATOR|ONEUSE|NOCLIP_ALLY|AUTOLAUNCH, name="S-100's Frag", group=2, blockshape=MISSILE, lifetime=15.000, 
  ...
  {81, name="Mjolnir Cannon", features=PALETTE|TURRET|CANNON, group=8, scale=5, barrelTaper=0.8, barrelOffset={-30, 0},
  ...
  {17059, name="Flak Spitter", features=PALETTE|TURRET|CANNON|AUTOFIRE, group=8, shape=OCTAGON, durability=0.5, barrelOffset={-1, 0},
...
--(17178 USED ID)
  ...
  {17242, name="Photon Projector", features=PALETTE|LASER, group=8, durability=0.500, shape=CANNON2,
...
--(17295 Unused)
  ...
  {17298, group=8, name="Limpet Missiles", features=PALETTE|LAUNCHER, shape=204, fillColor=0x1e90ff, fillColor1=0x00688b, lineColor=0x87ceff, sort=110095,
      durability=0.5, density=0.15, replicateBlock={group=8, command={faction=8}, name="Nimbat Pellets", features=COMMAND|THRUSTER|EXPLODE|TORQUER|FIN,
      shape=SQUARE_HALF, durability=1, lifetime=3,
      ...
      explodeDamage=20, explodeRadius=20}, replicateTime=0.2, launcherAngVel=20, launcherOutSpeed=400,
	  blurb="Rapid firing mid range missile launcher, this explosive packets launcher is designed for close in combat (planned to have a STICKY feature)"},
  ...
  {17302, group=8, name="Photon Mine", features=PALETTE|LAUNCHER, shape=204, fillColor=0x1e90ff, fillColor1=0x00688b, lineColor=0x87ceff, sort=110094,
	  ...
	  launcherSpeed=360, launcherPower=120, blurb="Launches a remote photon mine which deal high collision damage on impact which might disables shields"},
...
//--PLANT PARTS CULTIVATOR
  ...
  {17818, shape=OCTAGON, scale=2, group=15, features=PALETTE|LAUNCHER|LASER|TURRET|CHARGING, name="Vardictor Orb Launcher",
    blurb="A laser orb launcher turret which also fires it main laser weaponry to pull hostile ships close",
	barrelOffset={-22.5, 0}, laser={width=10, damage=500, color=0x4221ff00, range=2200, linearForce=-250000}, chargeMin=0.5, chargeMaxTime=2,
    fillColor=0x2a2a2a, fillColor1=0x2f8b2f, lineColor=0xc4f4c4, durability=0.5, density=0.15, replicateBlock=
	{features=COMMAND|LASER|TURRET|NOCLIP_ALLY|CHARGING|AUTOFIRE|GENERATOR|THRUSTER|TORQUER|FREERES, command={}, group=15, shape=OCTAGON, fillColor=0x2abc2a, fillColor1=0x2f8b2f, lineColor=0xc4f4c4, durability=0.5, density=0.15,
	  lifetime=20, laser={width=4, damage=240, color=0x4221ff00, range=900}, turretSpeed=30, chargeMin=1, chargeMaxTime=2, powerCapacity=1000, generatorCapacityPerSec=200,
	  cannon={damage=100, roundsPerSec=10, roundsPerBurst=10, burstyness=1, range=100, muzzleVel=1000, spread=2.828, color=0x20fa20, pattern=ABSOLUTE|SPIRAL,
  ...
  {17820, shape=OCTAGON, scale=2, group=8, features=PALETTE|LAUNCHER|TURRET, name="Nanofiber Thread Launcher", sort=310093, turretLimit=0,
    blurb="Devastating againsts anything that moves onward into its trails... Ineffective against immobile or kiting tactic targets", points=230,
	...
	explosive=FRAG_FINAL, fragment={damage=1, roundsPerBurst=1, muzzleVel=-1500, rangeStdDev=-100, color=0x6020fafa, pattern=CONSTANT|ABSOLUTE, spread=0.1}}}}}},
	  ...
	  cannon={damage=30, roundsPerSec=100, range=25, muzzleVel=1, color=0x8020fafa, pattern=ABSOLUTE}, generatorCapacityPerSec=500, powerCapacity=500}, replicateTime=0.001}, replicateTime=45, launcherPower=800, launcherOutSpeed=100000}
