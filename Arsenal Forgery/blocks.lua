{  
  ...
  {3, name="Repeater Drone", features=LAUNCHER, group=8, shape=RECT_LAUNCHER1,
    ...
    density=0.150, fillColor=0x113077, fillColor1=0x205079, lineColor=0x3390eb, replicateBlock=
    {command={}, name="SpecOp Drone", features=COMMAND|THRUSTER|GENERATOR|TURRET|CANNON|TORQUER|FREERES|TELEPORTER|SHIELD|NOCLIP_ALLY,
  ...
  {58, name="T-1A Shrapnel", features=LAUNCHER, group=2, blockshape=RECT_LAUNCHER1,
    ...
    {command={}, name="Shrapnel T-1", features=COMMAND|THRUSTER|GENERATOR|CANNON|TURRET|TORQUER|FREERES|AUTOFIRE|NOCLIP_ALLY,
		...
		fragment={damage=5, color=0xecfe00, rangeStdDev=400, roundsPerBurst=5, muzzleVel=1250, spread=1.250, pattern=WAVE}}, generatorCapacityPerSec=40.000},
  ...
  {17082, name="DVT-47A Aegisohn", features=SHIELD|LASER|TURRET|AUTOFIRE, group=2, durability=0.5,
    blurb="This defensive laser turret can fire outside the range of it's shield generator, it's basically a shield generator combined with defense laser", density=0.5,
    fillColor=0x61ffca, fillColor1=0x40f7d9, lineColor=0xa6ffdb, turretSpeed=10.824, shield={strength=10000,
      ...
      laser={width=2, damage=60, color=0x806effc5, range=200, explosive=ENABLED, explodeRadius=10},
     growRate=0.825},
